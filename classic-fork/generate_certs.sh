...
keyUsage=critical,keyCertSign,cRLSign")
    ...
    openssl x509 -req -days 365 -in server.csr \
        ...
        -out server-cert.pem \
        -extfile <(echo "subjectAltName=DNS:localhost,DNS:tls-test-server,IP:127.0.0.1,IP:192.168.1.100,IP:192.168.43.1,IP:3.108.41.178,IP:172.31.32.138,IP:15.206.70.28,IP:10.50.41.125,IP:10.116.107.88
